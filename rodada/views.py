...
def rodada_new(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            return render(request, 'rodada/rodada_new.html', {'form':form, 'numeroRodada':numeroRodada})
            # gambiarra alert (numero rodada = id?)
    else:
        form = Rodada_Form()
        return render(request, 'rodada/rodada_new.html', {'form': form, 'numeroRodada':numeroRodada})
...
def rodada_edit(request, id):
    ...
    return render(request, 'rodada/rodada_edit.html', {'form':form, 'numeroRodada':rodada.numeroRodada})
